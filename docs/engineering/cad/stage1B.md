...
For this module, keep this tab open and work your way through the FRCDesign.org theory pages and CAD exercises.

---

## 🚦 Step 1: Complete the Training Exercises

Click through the sections below. Make sure you read the theory sections carefully before attempting the exercises—FRC uses very specific hardware (like hex shafts) that you need to understand! *(Note: All links will open in a new tab).*
...
To prove you have mastered power transmissions, you need to submit your Onshape document containing your completed gearboxes.

1. Ensure your Onshape Document is named clearly (e.g., `FirstLast_Stage1B`).
2. Attach your wok to the onshape course to submit when complete.
...
[Go to Next Module: Stage 1C (Practice Mechanisms)](stage1C.md){ .md-button style="width: 100%; text-align: center; font-size: 1.2em; padding: 15px;" }

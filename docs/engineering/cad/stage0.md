...
|------|-------|---------------------|------------|------------|
| 1 | Introduction to CAD & Onshape Setup | Stage 0A | Overview of CAD, Onshape interface, account setup, MKCAD/Featurescripts installation | [Assignment 1: Onshape Setup & Basic Navigation](assignments/assignment1.md) |
| 2 | Sketching Fundamentals | Stage 0A | Sketch tools, constraints, dimensions | [Assignment 2: Basic Sketch Practice](assignments/assignment2.md) |
| 3 | Part Design Basics | Stage 0B | Extrude, revolve, basic features | [Assignment 3: Simple Part Design](assignments/assignment3.md) |
| 4 | Multi-Part Modeling | Stage 0C | Part Studio, multi-part workflows | [Assignment 4: Multi-Part Model](assignments/assignment4.md) |

...
* **Team Numbers** <span style="color: var(--md-primary-fg-color);">:material-numeric:</span>
...
* **2. Install Mounting Hardware (Do this FIRST!)** <span style="color: var(--md-primary-fg-color);">:material-nut:</span>
...
* **3. Attach the Bumper Foam** <span style="color: var(--md-primary-fg-color);">:material-tape-measure:</span>
...
* **4. Wrap the Fabric & Iron on Numbers** <span style="color: var(--md-primary-fg-color);">:material-iron:</span>
...
??? info "Method A: Two Sets of Bumpers (Standard)"
    ...
    **Cons:** Costs twice as much, takes up pit space, and takes time to swap bolts.

??? info "Method B: Reversible Bumpers"
    We build one set, but the fabric has a sewn-in flap with velcro that flips colors.
    **Pros:** Lightning-fast color changes. Cheaper on materials.
    **Cons:** Much harder to sew. Velcro can sag over time.

!!! success "The Panther Project Standard"
    We prefer to use **heavy-duty quick-release pins** (like ball-lock pins) through custom aluminum brackets. It allows the drive team to swap bumpers in seconds without carrying a wrench to the field.

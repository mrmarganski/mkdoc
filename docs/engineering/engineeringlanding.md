...
-   <span style="color: var(--md-primary-fg-color);">:material-cube-outline:</span> {{ path_2_1 }}
    ...
    *Design the machine.* Dive deep into Onshape CAD workflows, the Engineering Design Process, and complex mechanism design.
    ...
    [Start {{ path_2_1 }}](../engineering/cad/stage1D.md){ .md-button .md-button--primary }

-   <span style="color: var(--md-primary-fg-color);">:material-factory:</span> {{ path_2_2 }}

    ---

    *Build the machine.* Master heavy precision machinery including the CNC Router, Lathe, Milling Machine, and 3D Printers.
    
    [Start {{ path_2_2 }}](../fabrication/fabricationadvanced.md){ .md-button .md-button--primary }

-   <span style="color: var(--md-primary-fg-color);">:material-code-braces:</span> {{ path_2_3 }}

    ---

    *Bring the robot to life.* Master Java, WPILib, autonomous routines, sensor integration, and advanced control systems.
    
    [Start {{ path_2_3 }}](../engineering/programminglanding.md){ .md-button .md-button--primary }

-   <span style="color: var(--md-primary-fg-color);">:material-bullhorn:</span> {{ path_2_4 }}
    ...
    *Build the brand.* Known as: Non-Engineering Member Opportunities (NEMO), these members Master the non-technical tasks to elevate the team beyond just the robot.
    ...
    [Start {{ path_2_4 }}](../media/medialanding.md){ .md-button .md-button--primary }

...
The video above walks you through these steps to install WPIlib for XRP, but if you would like to do it on your own here is the official documentation below. 

!!! warning
    If you need to have VScode with WPIlib installed on your workstation watch the video, But **STOP** the video at the 14:03 marker: We will **NOT** be coding in Time Based format!

...
![Simulate XRP](https://github.com/mrmarganski/mkdoc/blob/194e676010a019d8608083b602f438e947356451/docs/img/simluatexrp.png){: style="max-width:280px; display:block; margin: 15px auto; border: 2px solid #333; border-radius: 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.3);" }

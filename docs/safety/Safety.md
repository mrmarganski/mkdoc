...
🚩 The "Big Three" Rules
!!! warning "Strict Compliance Required"
    * **Safety Glasses:** Must be worn at all times in the shop.
    * **Proper Shoes:** Substantial, closed-toe shoes only. No Crocs, sandals, or flip-flops.
    * **Safe Hair/Clothes:** Long hair must be tied back; no dangling hoodie strings, loose jewelry, or baggy clothing.
...
5.  [Shop & Tool Safety](#power-and-hand-tool-safety)
6.  [Soldering & Electrical Safety](#soldering-safety)
7.  [Battery Safety](#battery-safety)
8.  [Emergency Procedures](#emergency-event-procedures)
...
* **S**ender: Is the address legitimate?
* **L**inks: Hover to check where they lead.
* **A**ttachments: Do not open unexpected files.
* **M**essage: Watch for suspicious tone or urgency.

---

!!! quote "Core Value Check"
    "Safety is not just a set of rules; it is a culture of looking out for one another."
